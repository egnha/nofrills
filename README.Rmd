...
variation of `function()` that:
  ...
  - **costs less** — enables Tidyverse
    ...
    [functional impurity](#what’s-the-point-of-quasiquotation?)
...
determined by its inputs. The reason is that a function’s behavior can be
mutated by changes in its
